...
public class InquilinoController : Controller
{
    ...
    public InquilinoController(ILogger<InquilinoController> logger, RepositorioInquilino repositorioInquilino)
    {
        _logger = logger;
    ...
    public IActionResult GuardarInquilino(Inquilino inquilino)
{
    ...
    {
        return Json(new { success = false, message = "Ocurrió un error al guardar el inquilino." });
    }
}
